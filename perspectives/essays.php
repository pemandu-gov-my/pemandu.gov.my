...
if($_GET)
{
    ...
    ?><img src="<?php echo "img/writers/".$row['name'].".jpg" ?>" align="left" style="margin: 5px 20px 10px 0;border:1px solid grey;">
...
else
{
    ...
    while($row = mysql_fetch_assoc($result))
    {
        ...
        <div style="width:90px;float:left;margin:0 10px 10px 0;">
            <div align="center" style="background:white;border:1px solid grey;width:90px;height:66px">
