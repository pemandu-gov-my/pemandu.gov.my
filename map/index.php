...
<?php
$starmap_state =  $_GET["state"];
if (!isset($starmap_state)) { $starmap_state = ""; }
else {}
$starmap_state = str_replace("\"", "\\\"", $starmap_state);
$starmap_state = str_replace("'", "\\'", $starmap_state);
$starmap_state = str_replace("\n", "\\n", $starmap_state);
?>
<script>
var starmap_state = "<?php echo $starmap_state; ?>";
...
function starmap_init(mapID, mapWidth, mapHeight)
{
  ...
  //----------------------------------------------------------------
  $("#starmap-controls-back").click(function() { window.location = "?state="; });
