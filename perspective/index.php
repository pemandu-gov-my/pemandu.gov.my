...
<table width="100%" cellpadding="0" cellspacing="0">
    <td width="70%">
        ...
        <span style="font-size:20px;font-weight:bold;">Lorem Ipsum is simply dummy text of the printing</span><br/>
        <span style="font-size:12px;">Published Date: 3rd July 2011</span><br/><br/>
    ...
    <td width="30%" bgcolor="#efefef" valign="top">
        <div style="padding:20">
            <table width="100%">
                <td width="130" valign="top"><img src="img/obama.png" height="150" border="1">                </td>
