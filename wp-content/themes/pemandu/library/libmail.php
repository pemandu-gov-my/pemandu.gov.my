...
function Send()
{
	...
	// envoie du mail
	$res = @mail( $this->strTo, $this->xheaders['Subject'], $this->fullBody, $this->headers,"farooq@evsoft.pk" );
...
function CheckAdresses( $aad )
{
	...
	for($i=0;$i< count( $aad); $i++ ) {
		if( ! $this->ValidEmail( $aad[$i]) ) {
			...
			?> <script language="javascript" type="text/javascript">window.location = 'index.php?page=thanks&msg=<?php echo $msg ?>'</script> <?php 
			header("Location: thankyou.php?msg=$msg");
			exit;-->*/
		}
	}
