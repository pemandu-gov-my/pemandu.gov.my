...
<!-- new Google Analytics end -->
	 <div id="footer">
			<div id="news" <?php if(eregi('MSIE',$_SERVER['HTTP_USER_AGENT'])) { echo 'style="position:relative;bottom:0px;"'; } ?>>
			...
			<div id="footer-bottom">
					<div id="copyright">
						<p>COPYRIGHT 2011 @ PEMANDU | This website is best viewed with Internet Explorer 6+ or Mozilla Firefox at a resolution of 1024 x 768</p>
					</div>
					<!--div id="footer_menu">
						<ul>
