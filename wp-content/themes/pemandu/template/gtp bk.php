	...
	<div id="home-area">
		...
		<div id="main_area">
			...
			<div id="header">
				...
				<div id="return"><p> <a href="<?php echo  bloginfo('siteurl') ?>">Main</a></p></div>
				...
				<div style="float: left; width: 80px;" >
					...
					<ul>
						...
						<li ><a  href="<?php echo  bloginfo('siteurl') ?>"id="homenav" style="margin-left: 19px; width: 41px; padding-bottom: 0px; height: 31px;">home</a></li>
				...
				<div class="menu"  >
					...
					<ul>
						...
						<li><a  href="http://www.pemandu.gov.my/gtp/perspectives" id="careerid" style="width:41px; width:70px; padding-bottom: 0px; height: 28px; float:left;" target="_blank" >PERSPECTIVES</a></li>
			...
			<div id="sidebar_right">
				...
				<p> The 1Malaysia Roadmap was launched on the 28th of January 2010, to a full house at the KL Convention Centre. </p>
				...
				<div id="tweets">
					...
					<h2>GTP tweets</h2><img src="<?php bloginfo('template_directory'); ?>/images/tweeterBird.png" style="position:absolute;right:80px;margin-top:-20px;">
				...
				<div class="feedback">
					...
					<img src="<?php echo bloginfo('template_directory'); ?>/images/speech.png" />

					<h2>Your Feedback matters</h2> 

					<p> Have a question or comment about the GTP? <br />

Share your thoughts by clicking on the button below.</p>

					<a href="../contact.php"><img src="<?php bloginfo('template_directory'); ?>/images/tell-us.png" /></a>
			...
			<div id="content-container">
					...
					<?php }?>
						...
						<?php 
								...
								echo substr(wordwrap(get_the_title(), 8, "\n", true), 0, 120);
								...
								echo "<p>";
								//the_content();
								echo  wordwrap(get_the_content(), 8, "\n", true);
				...
				?>
					...
					<div class="media_content_section" style="width:100%;">
						...
						<form id="contact-pemandu-form" name="contact-pemandu-form" method="post" action="">
							...
							<input type="submit" class="feedback_btn" src="<?php echo bloginfo('template_directory'); ?>/images/submit_button.png" id="submit" name="submit" value="" style="float: left;">

							<input type="image" src="<?php echo bloginfo('template_directory'); ?>/images/reset_button.png" id="reset" style="float: left;margin-left:10px;">
