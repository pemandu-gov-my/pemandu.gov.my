			...
			<div id="header">
				...
				<div class="menu"  >
					...
					<ul>
						...
						<li><a  href="<?php echo  bloginfo('siteurl') ?>/careers.php" id="careerid" style="width:41px; width:70px; padding-bottom: 0px; height: 28px; float:left;" target="_blank" >CAREERS</a></li>
