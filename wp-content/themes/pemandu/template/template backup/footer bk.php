			...
			<div id="news">
				...
				<a target="_parent" href="<?php echo bloginfo('siteurl'); ?>/?page_id=41"><img src="<?php echo bloginfo('template_directory'); ?>/images/view-all.png"></a>
					...
					<div id="col1">
						...
						<?php  echo  substr(wordwrap(get_the_title(), 10, "\n", true),0,20);//echo   $links_arr['field_label'];?></h3></a>
						<p><?php $content = wordwrap(get_the_content(), 8, "\n", true);
						if ( strlen(get_the_content()) > 5 ) { echo substr($content, 0, 120)."..."; } ?></p>  
		  
						<span class="readmore"><a href="<?php echo bloginfo('siteurl'); ?>/?p=<?php the_ID();//echo $links_arr['id']; ?>" style="color:#99BCCB;"> + Read More</a></span>
