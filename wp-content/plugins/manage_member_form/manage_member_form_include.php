<script type="text/javascript" src="<?php echo bloginfo('wpurl').'/wp-content/plugins/manage_member_form/'; ?>js/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="<?php echo bloginfo('wpurl').'/wp-content/plugins/manage_member_form/'; ?>js/jquery.form.js"></script>
<script type="text/javascript" src="<?php echo bloginfo('wpurl').'/wp-content/plugins/manage_member_form/'; ?>js/ajaxfunctions.js"></script>
<link type="text/css" rel="stylesheet" href="<?php echo bloginfo('wpurl').'/wp-content/plugins/manage_member_form/'; ?>css/mystyle.css" />
<script type="text/javascript" src="<?php echo bloginfo('wpurl').'/wp-content/plugins/manage_member_form/'; ?>js/colorbox/jquery.colorbox.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo bloginfo('wpurl').'/wp-content/plugins/manage_member_form/'; ?>css/colorbox/colorbox.css" />
<script>
...
display:none;
	...
	<div class="wrap">  
    <?php    echo "<h2>" . __( 'Manage News', 'oscimp_trdom' ) . "</h2><hr>"; ?>  
	<?php if($error_msg !=""){?>
	<div class="error_msg">
		<ul><?php echo $error_msg; ?></ul>
	</div>
	<?php }?>
<p class="flip_gifts">Add News</p>
<div class="add_mem_fields">
     <form name="add_member_field_frm" id="add_member_field_frm" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
         <input type="hidden" name="dir_frm_hidden" value="Y">  
         <?php    echo "<h4 style='color:#21759B; text-align:left; margin-left:20px;'>" . __( 'Add News', 'oscimp_trdom' ) . "</h4>"; ?> 
		 <div id="error_div" class="errordiv"></div>
         <p class="p_height">
		 	<span class="span_label">News Title</span>
			<span class="span_field"><input type="text" name="news_title" id="news_title" value="<?php echo $_POST['news_title'];?>" size="20"><?php _e(" "); ?></span>
		 </p>
		 <p class="p_height">
		 	<span class="span_label">News Description</span>
			<span class="span_field">
			<?php 
         ...
         <p class="submit" style="text-align:left; margin-left:170px;">  
         <input type="submit" name="Submit" value="<?php _e('Add', 'oscimp_trdom' ) ?>" onclick="return validate_add__mem_field_frm();" />  
         </p>  
     </form> 
   </div> 
</div>
	...
	<table class="widefat fixed" cellspacing="0">
		...
		<tbody id="users" class="list:user user-list">
			<?php
				global $wpdb;
				$form_fields_arr = $wpdb->get_results( "SELECT *  FROM pm_news ",ARRAY_A);
		...
		<tr id="field-<?php echo $form_fields_record_arr['id']; ?>" onmouseover="change_tr_color(this);" onmouseout="back_to_original(this);" bgcolor="<?php echo $bg_color;?>">
			...
			<td class="username column-username"><?php echo $form_fields_record_arr['field_label']; ?> 
				<strong>
			...
			<td class="name column-name">
				<?php  echo substr($form_fields_record_arr['field_name'],0,200); ?>
			</td>
