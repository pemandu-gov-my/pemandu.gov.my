...
var PLUGIN_PATH = SITE_HOME_PATH+'wp-content/plugins/add_youtube_videos/';
...
function validate_add__youtube_videos()
{
	$('#add_vido_field_frm').unbind('submit');
	var options = {
	target: '#error_div',	
	beforeSubmit: show_mem_field_Request, 	
	success: show_memfieldResponse, 		
	url: PLUGIN_PATH+'process/add_videos.php' 
	};
	$('#add_vido_field_frm').submit(function() {
