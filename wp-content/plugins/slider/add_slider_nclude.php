...
<script>
	...
	$(".pinploc").colorbox({width:"750px", height:"75%", iframe:true, overlayClose:false, opacity:0.60, 
	...
	<table class="widefat fixed" cellspacing="0">
		...
		<tr id="field-<?php echo $form_fields_record_arr['id']; ?>" onmouseover="change_tr_color(this);" onmouseout="back_to_original(this);" bgcolor="<?php echo $bg_color;?>">
			...
			<td class="username column-username"><img src="<?php echo $target_path; ?>" width="250" height="150" />
				...
				<span class="edit">
					<a href="<?php echo bloginfo('wpurl').'/wp-content/plugins/slider/'; ?>update_mem_frm.php?field_id=<?php echo $form_fields_record_arr[id];?>" class="pinploc">Edit</a> | 
				</span> 
