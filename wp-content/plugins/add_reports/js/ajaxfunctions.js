...
var PLUGIN_PATH = SITE_HOME_PATH+'wp-content/plugins/add_reports/';
...
function validate_add__reports()
{
	$('#add_report_field_frm').unbind('submit');
	var options = {
	target: '#error_div',	
	beforeSubmit: show_mem_field_Request, 	
	success: show_memfieldResponse, 		
	url: PLUGIN_PATH+'process/add_reports.php' 
	};
	$('#add_report_field_frm').submit(function() {
