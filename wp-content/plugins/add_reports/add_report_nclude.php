...
display:none;
	...
	<?php }?>
<p class="flip_gifts">Add Reports </p>
<div class="add_mem_fields">
     <form name="add_report_field_frm" id="add_report_field_frm" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
         ...
         <?php    echo "<h4 style='color:#21759B; text-align:left; margin-left:20px;'>" . __( 'Add Reports', 'oscimp_trdom' ) . "</h4>"; ?> 
	...
	<table class="widefat fixed" cellspacing="0">
		...
		<tbody id="users" class="list:user user-list">
			<?php
				global $wpdb;
				$form_fields_arr = $wpdb->get_results( "SELECT *  FROM pm_reports where status=1 order by id asc",ARRAY_A);
